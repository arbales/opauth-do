 ...
 * @package			Opauth.Do
 */
class DoStrategy extends OpauthStrategy {
	...
	public function request() {
		$url = 'https://do.com/oauth2/authorize';
		$params = array(
	...
	private function user($access_token) {
		$user = $this->serverGet('https://do.com/account', array('access_token' => $access_token), null, $headers);
